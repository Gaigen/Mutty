          ...
          {PROCESSING_TOGGLES.map(({ key, label, desc }) => (
            <label key={key} className="flex cursor-pointer items-center justify-between gap-3 py-1">
              ...
              <Switch
                ...
                onCheckedChange={(v: boolean) => setAudioSettings({ [key]: v })}
              />
            </label>
          ))}
        </div>
      ...
      <div>
        ...
        <label className="mb-3 flex cursor-pointer items-center justify-between gap-3 py-1">
          ...
          <Switch
            ...
            onCheckedChange={(v: boolean) => setAudioSettings({ noiseGateEnabled: v })}
          />
        </label>
      ...
      <div>
        ...
        <label className="flex cursor-pointer items-center justify-between gap-3 py-1">
          ...
          <Switch
            ...
            onCheckedChange={(v: boolean) => setAudioSettings({ joinLeaveSounds: v })}
          />
        </label>
      </div>
    </>
