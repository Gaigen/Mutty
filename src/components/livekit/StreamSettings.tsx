...
import { AppSettingsTab } from './stream-settings/app-tab';
import { HotkeysTab } from './stream-settings/hotkeys-tab';

type TabId = 'audio' | 'screen' | 'camera' | 'people' | 'stats' | 'hotkeys' | 'controls';
