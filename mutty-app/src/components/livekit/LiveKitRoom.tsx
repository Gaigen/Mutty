...
import { AudioMuteProvider, useAudioMute } from '../../context/AudioMuteContext';
...
import { CollabProvider, WhiteboardModule } from '@mutty/shared';
...
export default function LiveKitRoomComponent({ roomName, identity: providedIdentity, avatar, onLeave }: LiveKitRoomProps) {
  ...
  // All defaults read from saved settings — no hardcoded values
